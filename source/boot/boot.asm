...
section .boot   ; .boot section in linker

_start:
    jmp start   ; skip headers, this *must* be the first line of code
...
KERNEL_START    equ 0x7e00  ; address to place the start of the kernel
...
title_msg       db "       -- Sapphire OS v0.1 - Ben Ratcliff 2022 --",                     0xA, 0xD, 0     ; 52 chars
